 ...
 * <p>
 * A Persist instance is bound to a {@link Connection} object.
 ...
 * {@link Connection} objects are not thread safe.
 * <p>
 ...
 * auto-generated keys in {@link PreparedStatement}
...
public final class Persist {
	 ...
	 * 
	 * @param connection {@link Connection} object to be used
	 * @since 1.0
	 */
	 ...
	 * 
	 * @param objectClass {@link Class} object to get a
	...
	/**
	 * Returns the {@link Connection Connection} associated with this
	 * Persist instance.
	 * @since 1.0
	 */
	...
	/**
	 * Commits the {@link Connection Connection} associated with this
	 * Persist instance.
	 * 
	...
	/**
	 * Rolls back the {@link Connection Connection} associated with
	 ...
	 * {@link Connection Connection} associated with this Persist
	 * instance.
	...
	/**
	 * Creates a {@link PreparedStatement}, setting the names of the
	 * auto-generated keys to be retrieved.
	 * 
	 * @param sql SQL statement to create the {@link PreparedStatement}
	 * from
	...
	/**
	 * Creates a {@link PreparedStatement} with no parameters.
	 * 
	 * @param sql SQL statement to create the {@link PreparedStatement}
	 * from
	 * @since 1.0
	 ...
	 * 
	 * @param statement {@link PreparedStatement} to be closed
	...
	/**
	 * Returns the last {@link PreparedStatement} used by the engine.
	 * 
	 * @since 1.0
	 */
	...
	/**
	 * Closes the last {@link PreparedStatement} used by the engine.
	 * 
	 * @see PreparedStatement#close()
	 * @since 1.0
	 */
	...
	/**
	 * Sets the behavior for closing {@link PreparedStatement}
	 ...
	 * {@link PreparedStatement} instances automatically closed.
	 * <p>
	 ...
	 * {@link PreparedStatement} instances for read queries will be
	...
	/**
	 * Returns true if {@link PreparedStatement} instances are
	 ...
	 * </ul>
	 * 
	 * @param stmt {@link PreparedStatement} to have parameters set
	 * into
	 ...
	 * {@link ResultSet} and returns an instance of the specified Java
	 * {@link Class} containing the values read.
	 * <p>
	 * This method is used while converting {@link ResultSet} rows to
	 ...
	 * for a null value from the {@link ResultSet}.
	 * 
	 * @param resultSet {@link ResultSet} (positioned in the row to be
	 * processed)
	...
	/**
	 * Reads a column from the current row in the provided
	 * {@link ResultSet} and return a value correspondent to the SQL
	 ...
	 * comes from the {@link ResultSetMetaData ResultSetMetaData} for a
	 * given column.
	 * <p>
	...
	/**
	 * Reads a row from the provided {@link ResultSet} and converts it
	 ...
	 * object.
	 * 
	 * @param object {@link Object} to have fields mapped to
	...
	/**
	 * Returns an {@link Iterator} for a list of objects from the
	...
	/**
	 * Returns an {@link Iterator} for a list of all objects in the
	...
	/**
	 * Reads a single object from the database by mapping the results of the SQL
	 * query into an instance of {@link Map}.
	 * <p>
	...
	/**
	 * Reads a single object from the database by mapping the results of the
	 * PreparedStatement execution into an instance of {@link Map}.
	 * <p>
	 * Types returned from the database will be converted to Java types in the
	 * map according with the correspondence defined in
	 * {@link #getValueFromResultSet(ResultSet, int, int)}.
	...
	/**
	 * Reads a single object from the database by mapping the results of the
	 * current ResultSet row into an instance of {@link Map}.
	 * <p>
	 * Types returned from the database will be converted to Java types in the
	 * map according with the correspondence defined in
	 * {@link #getValueFromResultSet(ResultSet, int, int)}.
	 ...
	 * PreparedStatement execution results to instances of {@link Map}.
	 * <p>
	 * Types returned from the database will be converted to Java types in the
	 * map according with the correspondence defined in
	 * {@link #getValueFromResultSet(ResultSet, int, int)}.
	 ...
	 * results to instances of {@link Map}.
	 * <p>
	 * Types returned from the database will be converted to Java types in the
	 * map according with the correspondence defined in
	 * {@link #getValueFromResultSet(ResultSet, int, int)}.
	...
	/**
	 * Reads a list of all objects in the database mapped to the given object
	 * class and return each result as an instance of {@link Map}.
	 * <p>
	 * Types returned from the database will be converted to Java types in the
	 * map according with the correspondence defined in
	 * {@link #getValueFromResultSet(ResultSet, int, int)}.
	...
	/**
	 * Returns an {@link Iterator} for a list of {@link Map}
